...
| Constitutional pack (docs only) | N/A | `04-consentchain/` (overlay; not the implementation tree) | `04-consentchain/REPO_MAP.json`, `04-consentchain/BUILD_CONTRACT.md` |
...
- **`04-consentchain/`** is the **constitutional artifact pack**; **`projects/consentchain`** is the **implementation submodule**. They are intentionally distinct.
