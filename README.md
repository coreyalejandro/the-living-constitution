...
**Current repo status (PASS 10A):** read [`STATUS.md`](STATUS.md) (human mirror) or authoritative [`STATUS.json`](STATUS.json). Regenerate after inventory or policy changes: `python3 scripts/render_status_surface.py --root .`
