...
- **Next action:** (1) **Done** — **Verify Living Constitution** green on `9b26072` (run `24015419165`, workflow_dispatch). (2) Open **A-1** only after reading **`projects/c-rsp/CANONICAL_ROLE_MAP.md`** (**Downstream gate** section). (3) Run `./scripts/run_fde_control_plane_verification.sh` after pulls if FDE paths change.
