...
| --- | --- | --- | --- |
| 2026-04-06 | f22fd8d | `projects/c-rsp/README.md` operator guide; A-1 draft `BUILD_CONTRACTS/CRSP-A1-TAXONOMY-CANONICALIZATION-001.md`; refresh `last_verified` (CI STALE_COMMIT set) | MVDS row below |
