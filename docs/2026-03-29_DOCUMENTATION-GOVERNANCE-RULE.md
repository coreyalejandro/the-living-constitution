...
- Failure taxonomy exists in three locations: `08-evaluation/failure_taxonomy.md`, `08-evaluation/datasets/failure_cases.json`, and inline within `THE_LIVING_CONSTITUTION.md` Section 4.
...
| Failure taxonomy F1-F5 | `08-evaluation/failure_taxonomy.md` | Constitutional Operator | 2026-03-29 |
...
**Passes:** Failure taxonomy F1-F5 is defined in `08-evaluation/failure_taxonomy.md`. The inline summary in `THE_LIVING_CONSTITUTION.md` Section 4 says: "See `08-evaluation/failure_taxonomy.md` for the complete failure taxonomy. Summary: F1 (Confident False Claims), F2 (Phantom Completion), F3 (Persistence Under Correction), F4 (Harm-Risk Coupling), F5 (Cross-Episode Recurrence)."

**Fails:** Failure taxonomy F1-F5 is fully defined in both `08-evaluation/failure_taxonomy.md` and `THE_LIVING_CONSTITUTION.md` Section 4, with different levels of detail and no cross-reference.
...
**Passes:** A build contract says: "This project implements Invariant I2 (No Phantom Work), defined at `00-constitution/invariants/I2.md`: 'No component, feature, or capability may be reported as complete unless it has been executed and its output independently verified.' The build contract's acceptance criteria operationalize I2 as follows: [project-specific criteria]."
...
| Reference without file path | DGR-3 | "See the failure taxonomy" without specifying `08-evaluation/failure_taxonomy.md` |
